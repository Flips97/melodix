...
urlpatterns = [
    ...
    path('playlists/<int:user_id>/<int:playlist_id>/', views.fav_playlist, name='fav_playlist'),
    path('playlists/<int:user_id>/<int:playlist_id>/', views.unfav_playlist, name='unfav_playlist'),
